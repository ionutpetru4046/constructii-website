export default function TermsPage() {
  return (
    <main className="relative min-h-screen bg-gradient-to-tr from-slate-50 to-blue-100 dark:from-slate-900 dark:to-slate-700 flex flex-col items-center py-16 px-4">
