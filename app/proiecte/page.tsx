    ...
    <main className="min-h-screen bg-gradient-to-br from-blue-900 via-blue-700 to-yellow-500 py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-8">
        ...
        <section className="mb-20">
          <p className="mx-auto max-w-3xl text-lg text-blue-100/85 mb-10 text-center font-medium">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="group bg-gradient-to-t from-blue-950 via-blue-900/95 to-yellow-50/90 border border-blue-800 rounded-2xl shadow-lg transition hover:scale-105 hover:shadow-2xl overflow-hidden flex flex-col">
              ...
              <div className="p-6 flex-1 flex flex-col gap-2">
                ...
                <p className="text-blue-100 flex-1 font-medium">
        ...
        <section className="text-center mt-24">
          <h2 className="text-3xl md:text-4xl font-extrabold text-yellow-200 mb-8 drop-shadow">
            Vrei să vezi mai multe?
          </h2>
          <a
            href="/contact"
            className="inline-block bg-gradient-to-r from-yellow-400 via-yellow-500 to-yellow-600 text-blue-950 px-10 py-4 rounded-full font-semibold shadow-lg transition hover:from-yellow-500 hover:to-yellow-700 hover:scale-105 focus:outline-none focus-visible:ring-2 focus-visible:ring-yellow-300"
          >
